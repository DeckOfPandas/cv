...
\normalfont{
	...
	Built a complex mathematical and statistical model in Java in order to test the hypothesis that an algorithm relying entirely on discrete time series analysis could not achieve the level of performance of human listeners in a behavioural task\\
...
\normalfont{
	Classification: II(i)  \\
	Part II course: Experimental Psychology, research project in auditory psychophysics \\
...
\normalfont
\begin{itemize}
	\item Contributed to the organisation of sixteen health and care technology hackathons over five years with the tagline ``Making NHS IT Less Bad", four as lead or sole organiser\\
